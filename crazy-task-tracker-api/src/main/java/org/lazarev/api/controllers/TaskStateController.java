...
import org.lazarev.api.factories.TaskStateDtoFactory;
import org.lazarev.store.entities.ProjectEntity;
import org.lazarev.store.entities.TaskStateEntity;
import org.lazarev.store.repositories.TaskStateRepository;
...
public class TaskStateController {
    ...
    public static final String DELETE_TASK_POSITION = "/api/task-states/{task_state_id}";
    ...
    public TaskStateDto changeTaskPosition(
        ...
        Optional<Long> optionalOldLeftTaskStateId = changeTaskState.getLeftTaskState()
        ...
        Optional<TaskStateEntity> optionalNewLeftTaskState = optionalLeftTaskStateId
                .map(leftTaskStateId -> {
                    ...
                    if (taskStateId.equals(leftTaskStateId)) {
                        throw new BadRequestException("Left tsk state id equals changed task state.");
                    }
    ...
    @DeleteMapping(DELETE_TASK_POSITION)
    ...
    private TaskStateEntity getTaskStateOrThrowException(Long taskStateId) {
        return taskStateRepository
                ...
                .orElseThrow(() ->
                        new NotFoundException(String.format("Task state with\"%s\" id doesn't exist",
                                taskStateId)));
    }
}
